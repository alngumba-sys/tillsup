...
import { Plus, Edit, Ban, CheckCircle2, Tag, Upload, Download, FileSpreadsheet, AlertTriangle, XCircle } from "lucide-react";
...
export function CategoriesTab() {
  ...
  const handleDisableCategory = (id: string, name: string) => {
    disableCategory(id);
    toast.success(`Category "${name}" has been disabled`);
  };

  const handleEnableCategory = (id: string, name: string) => {
    enableCategory(id);
