...
export function TillsupLogo({ className, width, height, style, onClick }: TillsupLogoProps) {
  return (
    ...
    >
      ...
      <g>
        {/* Base */}
        <rect x="4" y="32" width="32" height="8" rx="2" fill="#0891b2" />
        
        {/* Screen/Display */}
        <rect x="8" y="12" width="24" height="18" rx="2" fill="#0891b2" />
        <rect x="11" y="15" width="18" height="12" rx="1" fill="white" fillOpacity="0.9" />
        
        {/* Display lines (receipt lines) */}
        <line x1="13" y1="18" x2="27" y2="18" stroke="#0891b2" strokeWidth="1.5" strokeLinecap="round" />
        <line x1="13" y1="21" x2="24" y2="21" stroke="#0891b2" strokeWidth="1.5" strokeLinecap="round" />
        <line x1="13" y1="24" x2="26" y2="24" stroke="#0891b2" strokeWidth="1.5" strokeLinecap="round" />
      ...
      <g transform="translate(48, 0)">
        {/* T */}
        <path d="M 4 10 L 16 10 M 10 10 L 10 34" stroke="#0891b2" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" />
        
        {/* i */}
        <circle cx="23" cy="12" r="2" fill="#0891b2" />
        <line x1="23" y1="18" x2="23" y2="34" stroke="#0891b2" strokeWidth="3.5" strokeLinecap="round" />
        
        {/* l */}
        <line x1="32" y1="10" x2="32" y2="34" stroke="#0891b2" strokeWidth="3.5" strokeLinecap="round" />
        
        {/* l */}
        <line x1="41" y1="10" x2="41" y2="34" stroke="#0891b2" strokeWidth="3.5" strokeLinecap="round" />
