...
import { AlertTriangle, Mail, Phone, MessageCircle, ArrowLeft, CreditCard } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="text-slate-400 mt-2">Your subscription payment is past due</p>
        </div>

        {/* Main Card */}
        <Card className="bg-slate-900/50 backdrop-blur border-white/10 shadow-xl">
          <CardHeader className="pb-4">
            <CardTitle className="text-white text-lg">Subscription Past Due</CardTitle>
            <CardDescription className="text-slate-400">
              {business?.name || "Your business"}'s subscription payment has failed.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <Alert className="bg-amber-500/10 border-amber-500/30">
              ...
              <AlertDescription className="text-amber-200">
                Your payment method was declined or your subscription payment is overdue. Please update your payment method to continue using Tillsup without interruption.
              </AlertDescription>
            </Alert>
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-semibold text-slate-300 uppercase tracking-wider">Need Help?</h3>
        ...
        <p className="text-center text-xs text-slate-500">
          Update your payment method to restore full access. Your data is safe.
        </p>
      </div>
    </div>
  );
