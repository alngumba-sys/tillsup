...
import { ShieldOff, Mail, Phone, MessageCircle, ArrowLeft } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="text-slate-400 mt-2">Your account has been temporarily suspended</p>
        </div>

        {/* Main Card */}
        <Card className="bg-slate-900/50 backdrop-blur border-white/10 shadow-xl">
          <CardHeader className="pb-4">
            <CardTitle className="text-white text-lg">Access Restricted</CardTitle>
            <CardDescription className="text-slate-400">
              {business?.name || "Your business"}'s account has been suspended.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <Alert className="bg-orange-500/10 border-orange-500/30">
              ...
              <AlertDescription className="text-orange-200">
                Your account has been suspended by an administrator. This may be due to a policy violation or payment issue. Please contact our support team for resolution.
              </AlertDescription>
            </Alert>
        ...
        <p className="text-center text-xs text-slate-500">
          Your data is preserved and will be restored once your account is unsuspended.
        </p>
      </div>
    </div>
  );
