...
INSERT INTO profiles (id, email, full_name, role, business_id, can_create_expense, created_at)
SELECT 
  u.id,
  u.email,
  COALESCE(u.raw_user_meta_data->>'first_name' || ' ' || u.raw_user_meta_data->>'last_name', u.email) as full_name,
